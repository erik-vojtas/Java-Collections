        ...
        while (!quit) {
            ...
            switch (action) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    // going backwards - play previous song
                    if(forward) {
                ...
                case 3:
                    // play the same song again - repeat the song
                    if(forward) {
                        if(listIterator.hasPrevious()) {
                            System.out.println("Now playing " + listIterator.previous().toString());
                            forward = false;
                ...
                case 6:
                    // delete song
                    if(playList.size() > 0) {
                        System.out.println(listIterator.previous() + " HAS BEEN REMOVED.");
                        listIterator.remove();
                        if(listIterator.hasNext()) {
